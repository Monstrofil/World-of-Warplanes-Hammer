package wowp.hud
{
   ...
   public class HUD extends Sprite
   {
      ...
      public static var _model:HUDModel;
      ...
      public function HUD()
      {
         ...
         _model = new HUDModel();
         _model.addEventListener(HUDModel.MODEL_INITIALIZED,this.modelInitHandler);
         _model.addEventListener(HUDModel.DISPOSE,this.disposeHandler);
         _model.control.onEscPressed.add(this.escPressed);
         ...
         this._mapping = new wowp.hud.HUDMapping(this._layoutManager,_model);
         ...
         addChild(_loc2_);
         _loc2_.load(new URLRequest("modsBackground.swf"),new LoaderContext(false,ApplicationDomain.currentDomain));
         if(stage)
         {
      ...
      public function disposeHandler(param1:Event) : void
      {
         ...
         _model.removeEventListener(HUDModel.DISPOSE,this.disposeHandler);
         _model.control.onEscPressed.remove(this.escPressed);
         _model.dispose();
      ...
      {
         _model.removeEventListener(HUDModel.MODEL_INITIALIZED,this.modelInitHandler);
         this.mcInfoEntities = new InfoEntities();
         addChildAt(this.mcInfoEntities,0);
         this.mcInfoEntities.setModel(_model);
      }
