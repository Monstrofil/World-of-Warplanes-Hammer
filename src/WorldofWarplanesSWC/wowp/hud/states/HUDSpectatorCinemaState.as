package wowp.hud.states
{
   ...
   public class HUDSpectatorCinemaState extends HUDState
   {
       
      public function HUDSpectatorCinemaState()
      {
         super();
      }
      ...
      override protected function onEnter() : void
      {
         ...
         model.control.hideBackendGraphics(false,HUDControlModel.STATE_SPECTATORCINEMA);
      ...
      protected function setChatVisible() : void
      {
         ...
         {
            pushState(HUDChatSpectatorCinemaState);
         }
      }
      ...
      {
         pushState(HUDMenuSpectatorCinemaState);
      }
      ...
      {
         pushState(HUDCursorSpectatorCinemaState);
      }
      ...
      {
         pushState(HUDTabSpectatorCinemaState);
      }
   }
}
